...
async function main() {
  ...
  // Closed slug listesi (paketi 1-43)
  ...
  console.log(`Closed slugs (paketi 1-43): ${closedSlugs.size}`);
  ...
  console.log(`\n=== Hit count: ${hits.length} (jenerik scaffold pattern, paketi 1-43'te kapatılmamış) ===`);
