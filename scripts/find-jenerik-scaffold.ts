...
async function main() {
  ...
  // Closed slug listesi (paketi 1-24)
  ...
  console.log(`Closed slugs (paketi 1-24): ${closedSlugs.size}`);
  ...
  console.log(`\n=== Hit count: ${hits.length} (jenerik scaffold pattern, paketi 1-24'te kapatılmamış) ===`);
