...
const recipes = [
  ...
  },
  {
    ...
    ingredients: [
      { name: "Kuşbaşı kuzu eti", amount: "500", unit: "gr", sortOrder: 1 },
      { name: "Patlıcan", amount: "4", unit: "adet", sortOrder: 2 },
      { name: "Soğan", amount: "2", unit: "adet", sortOrder: 3 },
      { name: "Domates", amount: "2", unit: "adet", sortOrder: 4 },
      { name: "Tereyağı", amount: "50", unit: "gr", sortOrder: 5 },
      { name: "Un", amount: "2", unit: "yemek kaşığı", sortOrder: 6 },
      { name: "Süt", amount: "200", unit: "ml", sortOrder: 7 },
      { name: "Kaşar peyniri", amount: "50", unit: "gr", sortOrder: 8 },
    ],
    steps: [
  ...
  },
  {
    ...
    tags: ["misafir-sofrasi", "yuksek-protein"],
    ingredients: [
      { name: "Kuşbaşı kuzu eti", amount: "400", unit: "gr", sortOrder: 1 },
      { name: "Patlıcan", amount: "3", unit: "adet", sortOrder: 2 },
      { name: "Süzme yoğurt", amount: "300", unit: "gr", sortOrder: 3 },
      { name: "Sarımsak", amount: "3", unit: "diş", sortOrder: 4 },
      { name: "Tereyağı", amount: "40", unit: "gr", sortOrder: 5 },
      { name: "Tuz, pul biber", amount: "1", unit: "tatlı kaşığı", sortOrder: 6 },
    ],
    steps: [
  ...
  // ── HAMUR İŞLERİ ──
  {
    ...
    tags: ["cocuk-dostu"],
    ingredients: [
      { name: "Un", amount: "3", unit: "su bardağı", sortOrder: 1 },
      { name: "Su", amount: "1", unit: "su bardağı", sortOrder: 2 },
      { name: "Maya", amount: "1", unit: "tatlı kaşığı", sortOrder: 3 },
      { name: "Kıyma", amount: "300", unit: "gr", sortOrder: 4 },
      { name: "Soğan", amount: "2", unit: "adet", sortOrder: 5 },
      { name: "Domates", amount: "2", unit: "adet", sortOrder: 6 },
      { name: "Biber salçası", amount: "2", unit: "yemek kaşığı", sortOrder: 7 },
      { name: "Maydanoz", amount: "1", unit: "demet", sortOrder: 8 },
      { name: "Pul biber, tuz", amount: "1", unit: "tatlı kaşığı", sortOrder: 9 },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Su", amount: "0.5", unit: "su bardağı", sortOrder: 3 },
      { name: "Kıyma", amount: "200", unit: "gr", sortOrder: 4 },
      { name: "Soğan (rendelenmiş)", amount: "1", unit: "adet", sortOrder: 5 },
      { name: "Yoğurt", amount: "300", unit: "gr", sortOrder: 6 },
      { name: "Sarımsak", amount: "3", unit: "diş", sortOrder: 7 },
      { name: "Tereyağı", amount: "50", unit: "gr", sortOrder: 8 },
      { name: "Pul biber", amount: "1", unit: "yemek kaşığı", sortOrder: 9 },
    ],
    steps: [
  ...
  // ── TATLILAR ──
  {
    ...
    tags: ["misafir-sofrasi"],
    ingredients: [
      { name: "Tel kadayıf", amount: "250", unit: "gr", sortOrder: 1 },
      { name: "Künefe peyniri", amount: "200", unit: "gr", sortOrder: 2 },
      { name: "Tereyağı (eritilmiş)", amount: "100", unit: "gr", sortOrder: 3 },
      { name: "Şeker", amount: "2", unit: "su bardağı", sortOrder: 4 },
      { name: "Su", amount: "1.5", unit: "su bardağı", sortOrder: 5 },
      { name: "Limon suyu", amount: "1", unit: "tatlı kaşığı", sortOrder: 6 },
      { name: "Antep fıstığı", amount: "2", unit: "yemek kaşığı", sortOrder: 7 },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { name: "İrmik", amount: "1", unit: "su bardağı", sortOrder: 1 },
      { name: "Un", amount: "1", unit: "su bardağı", sortOrder: 2 },
      { name: "Şeker", amount: "1", unit: "su bardağı", sortOrder: 3 },
      { name: "Yumurta", amount: "3", unit: "adet", sortOrder: 4 },
      { name: "Yoğurt", amount: "1", unit: "su bardağı", sortOrder: 5 },
      { name: "Kabartma tozu", amount: "1", unit: "paket", sortOrder: 6 },
      { name: "Şerbet şekeri", amount: "2", unit: "su bardağı", sortOrder: 7 },
      { name: "Şerbet suyu", amount: "2.5", unit: "su bardağı", sortOrder: 8 },
      { name: "Limon suyu", amount: "1", unit: "yemek kaşığı", sortOrder: 9 },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Leblebi (servis)", amount: "2", unit: "yemek kaşığı", sortOrder: 5 },
    ],
    steps: [
