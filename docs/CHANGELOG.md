...
- ✨ **Codex batch 12 — 100 tarif** (18 Nis oturum 4). 72 TR (Lalanga, Cızlak, Van Kavut, Sürk Ezmesi, Perde Pilavı, Keşkek, Tirit, Banduma, Laz Böreği, Höşmerim, Nevzine, Paluze…) + 28 uluslararası (5 se/5 hu/4 pe/5 gb/4 pl/5 au). DB 1100 → **1200 tarif** (dev). Codex teslimi Windows-1252→UTF-8 mojibake-korupt çıktı; HEAD restore + temiz batch 12 bloğu (satır 12376-12476) izole append ile kurtarıldı.
