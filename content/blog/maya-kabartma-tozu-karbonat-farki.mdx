...
**Nerede kullanılır:** Ekmek, pide, lahmacun tabanı, simit, poğaça, tatlı çörek, pizza hamuru. Mayanın doğru kabarması için unun protein oranı kritik; [un çeşitleri rehberi](/blog/un-cesitleri-protein-kullanim-rehberi) hangi un hangi hamurda iş görür ayrıntısıyla anlatıyor (ekmek için %12+, kek için %8-10).
