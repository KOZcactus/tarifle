...
- **Bulgur (esmer)**: pişirme 1:2 oranı, 12-15 dk, 83 kcal, 3.1 g protein, 4.5 g lif, GI 48, glüten var.
- **Pirinç (basmati esmer)**: 1:2.25 oranı, 35-40 dk, 110 kcal, 2.6 g protein, 1.8 g lif, GI 50, glütensiz.
- **Karabuğday (kasha)**: 1:2 oranı, 18-20 dk, 92 kcal, 3.4 g protein, 2.7 g lif, GI 45, glütensiz.
- **Kinoa**: 1:2 oranı, 15-18 dk, 120 kcal, 4.4 g protein, 2.8 g lif, GI 53, glütensiz.
- **Yulaf (ezilmiş, kabuk dışı)**: 1:2 oranı, 5-8 dk, 71 kcal, 2.5 g protein, 1.7 g lif, GI 52-58, glüten var (kontrolsüz işleme hattındaysa).
...
Hangi tahıl hangi yemeğe uyar:

- **Klasik kabarık pilav**: baldo veya basmati pirinç. Tane ayrı durur, kabarır.
- **Köftelik karışım**: ince bulgur (köftelik). Su tutar ve bağlar.
- **Soğuk salata, kısır**: pilavlık bulgur veya kinoa. Tane şekli soğukta korunur.
- **Çorbada koyulaştırıcı**: esmer bulgur veya yarma. Lifli kıvam verir.
- **Glütensiz alternatif**: karabuğday, kinoa, pirinç. Hiçbiri buğday içermez.
- **Sıcak kahvaltı**: yulaf, çelik kesim veya ezilmiş tip. Yumuşak doku, hızlı pişer.
- **Yüksek protein bowl**: kinoa. 4.4 g protein / 100 g, bitkisel kaynaklarda nadir.
- **Ekonomik temel karbonhidrat**: bulgur veya pirinç. Kilogram fiyatı en düşük seviyede.
