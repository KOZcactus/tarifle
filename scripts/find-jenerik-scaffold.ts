...
async function main() {
  ...
  // Closed slug listesi (paketi 1-29)
  ...
  console.log(`Closed slugs (paketi 1-30): ${closedSlugs.size}`);
  ...
  console.log(`\n=== Hit count: ${hits.length} (jenerik scaffold pattern, paketi 1-30'te kapatılmamış) ===`);
