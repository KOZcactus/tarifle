...
- **Batch 13 Mod B çevirisi prod'a canlı** — 101 tarif EN+DE `ingredients` + `steps` + `tipNote` + `servingSuggestion`. Dev: 101/101 apply + audit-deep PASS. Prod: 101/101 apply + audit-deep 0 CRITICAL. Batch 14 ilk yarı (50 tarif) dev'de uygulandı, prod onay bekliyor. Batch 14 ikinci yarı Codex'te.
