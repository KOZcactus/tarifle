  ...
  const recipes = [
    {
      ...
      ingredients: [{ name: "Patlıcan", amount: "4", unit: "adet", sortOrder: 1 }, { name: "Kıyma", amount: "300", unit: "gr", sortOrder: 2 }, { name: "Soğan", amount: "2", unit: "adet", sortOrder: 3 }, { name: "Domates", amount: "2", unit: "adet", sortOrder: 4 }, { name: "Biber salçası", amount: "1", unit: "yemek kaşığı", sortOrder: 5 }, { name: "Sivri biber", amount: "2", unit: "adet", sortOrder: 6, isOptional: true }, { name: "Sarımsak", amount: "3", unit: "diş", sortOrder: 7 }, { name: "Tuz", amount: "1", unit: "çay kaşığı", sortOrder: 8 }, { name: "Karabiber", amount: "0.5", unit: "çay kaşığı", sortOrder: 9 }, { name: "Sıvı yağ", amount: "3", unit: "yemek kaşığı", sortOrder: 10 }],
      steps: [{ stepNumber: 1, instruction: "Patlıcanları yıkayın ve alacalı soyun. Ortadan yarıp tuzlu suda 15 dakika bekletin.", tip: "Tuzlu su hem acılığı alır hem de yağ çekmesini azaltır.", timerSeconds: 900 }, { stepNumber: 2, instruction: "Patlıcanları sudan çıkarıp kurulayın. Kızgın yağda her iki tarafını kızartın." }, { stepNumber: 3, instruction: "Soğanları ince doğrayın. Ayrı bir tavada yağda pembeleşene kadar kavurun." }, { stepNumber: 4, instruction: "Kıymayı ekleyin, suyunu çekene kadar karıştırarak pişirin.", tip: "Kıymayı sürekli karıştırın ki topaklanmasın." }, { stepNumber: 5, instruction: "Doğranmış domatesleri, salçayı, sarımsağı ve baharatları ekleyin. 5 dakika pişirin.", timerSeconds: 300 }, { stepNumber: 6, instruction: "Kızartılmış patlıcanları tepsiye dizin, ortalarını açıp kıymalı harcı doldurun." }, { stepNumber: 7, instruction: "Önceden ısıtılmış 180°C fırında 25 dakika pişirin.", tip: "Üzerine biraz sıcak su eklemek pişirmeyi kolaylaştırır.", timerSeconds: 1500 }],
    },
    {
      ...
      ingredients: [{ name: "Kırmızı mercimek", amount: "1.5", unit: "su bardağı", sortOrder: 1 }, { name: "Soğan", amount: "1", unit: "adet", sortOrder: 2 }, { name: "Havuç", amount: "1", unit: "adet", sortOrder: 3 }, { name: "Patates", amount: "1", unit: "adet", sortOrder: 4 }, { name: "Domates salçası", amount: "1", unit: "yemek kaşığı", sortOrder: 5 }, { name: "Su", amount: "6", unit: "su bardağı", sortOrder: 6 }, { name: "Tereyağı", amount: "1", unit: "yemek kaşığı", sortOrder: 7 }, { name: "Tuz", amount: "", unit: "", sortOrder: 8 }, { name: "Karabiber", amount: "", unit: "", sortOrder: 9 }, { name: "Kimyon", amount: "", unit: "", sortOrder: 10 }],
      steps: [{ stepNumber: 1, instruction: "Mercimekleri yıkayın. Soğanı, havucu ve patatesi küçük küçük doğrayın." }, { stepNumber: 2, instruction: "Tencereye az yağ koyun, soğanı kavurun. Diğer sebzeleri ekleyin." }, { stepNumber: 3, instruction: "Mercimekleri ve suyu ekleyin. Kaynamaya bırakın.", timerSeconds: 1200 }, { stepNumber: 4, instruction: "Mercimekler yumuşayınca blender ile pürüzsüz hale getirin." }, { stepNumber: 5, instruction: "Tuz, karabiber ve kimyon ekleyin. Tereyağı ile servis edin." }],
    },
    {
      ...
      ingredients: [{ name: "Yumurta", amount: "3", unit: "adet", sortOrder: 1 }, { name: "Domates", amount: "2", unit: "adet", sortOrder: 2 }, { name: "Sivri biber", amount: "2", unit: "adet", sortOrder: 3 }, { name: "Tereyağı", amount: "1", unit: "yemek kaşığı", sortOrder: 4 }, { name: "Tuz", amount: "", unit: "", sortOrder: 5 }, { name: "Karabiber", amount: "", unit: "", sortOrder: 6 }, { name: "Pul biber", amount: "", unit: "", sortOrder: 7 }],
      steps: [{ stepNumber: 1, instruction: "Domatesleri ve biberleri küçük küçük doğrayın." }, { stepNumber: 2, instruction: "Tavada tereyağını eritin, biberleri kavurun." }, { stepNumber: 3, instruction: "Domatesleri ekleyin, suyunu çekene kadar pişirin.", timerSeconds: 300 }, { stepNumber: 4, instruction: "Yumurtaları kırıp ekleyin, hafifçe karıştırın. Pişince servis edin." }],
    },
    {
    ...
    },
    {
      ...
      ingredients: [{ name: "Kuru fasulye", amount: "2", unit: "su bardağı", sortOrder: 1 }, { name: "Soğan", amount: "1", unit: "adet", sortOrder: 2 }, { name: "Domates salçası", amount: "2", unit: "yemek kaşığı", sortOrder: 3 }, { name: "Biber salçası", amount: "1", unit: "yemek kaşığı", sortOrder: 4 }, { name: "Sıvı yağ", amount: "3", unit: "yemek kaşığı", sortOrder: 5 }, { name: "Sıcak su", amount: "4", unit: "su bardağı", sortOrder: 6 }, { name: "Tuz", amount: "", unit: "", sortOrder: 7 }, { name: "Karabiber", amount: "", unit: "", sortOrder: 8 }, { name: "Pul biber", amount: "", unit: "", sortOrder: 9 }],
      steps: [{ stepNumber: 1, instruction: "Fasulyeleri bir gece suda bekletin. Ertesi gün süzün." }, { stepNumber: 2, instruction: "Soğanı yağda kavurun. Salçaları ekleyin." }, { stepNumber: 3, instruction: "Fasulyeleri ve sıcak suyu ekleyin. Kısık ateşte pişirin.", timerSeconds: 3600 }, { stepNumber: 4, instruction: "Yumuşayınca tuz ve baharatları ekleyin." }],
    },
    {
      ...
      ingredients: [{ name: "Domates", amount: "3", unit: "adet", sortOrder: 1 }, { name: "Salatalık", amount: "2", unit: "adet", sortOrder: 2 }, { name: "Sivri biber", amount: "2", unit: "adet", sortOrder: 3 }, { name: "Soğan", amount: "1", unit: "adet", sortOrder: 4 }, { name: "Maydanoz", amount: "1", unit: "demet", sortOrder: 5 }, { name: "Zeytinyağı", amount: "", unit: "", sortOrder: 6 }, { name: "Limon", amount: "", unit: "", sortOrder: 7 }, { name: "Tuz", amount: "", unit: "", sortOrder: 8 }],
      steps: [{ stepNumber: 1, instruction: "Tüm sebzeleri küçük küçük doğrayın." }, { stepNumber: 2, instruction: "Derin bir kaseye alın." }, { stepNumber: 3, instruction: "Zeytinyağı, limon suyu ve tuz ile harmanlayın." }],
    },
    {
      ...
      ingredients: [{ name: "Yufka", amount: "3", unit: "adet", sortOrder: 1 }, { name: "Beyaz peynir", amount: "200", unit: "gr", sortOrder: 2 }, { name: "Maydanoz", amount: "1", unit: "demet", sortOrder: 3 }, { name: "Kızartma yağı", amount: "", unit: "", sortOrder: 4 }],
      steps: [{ stepNumber: 1, instruction: "Peyniri ufalayın, maydanozu kıyın, karıştırın." }, { stepNumber: 2, instruction: "Yufkayı üçgen kesin, iç harcı koyup rulo yapın." }, { stepNumber: 3, instruction: "Kızgın yağda altın rengi olana kadar kızartın.", timerSeconds: 300 }],
    },
    {
      ...
      ingredients: [{ name: "Patlıcan", amount: "4", unit: "adet", sortOrder: 1 }, { name: "Soğan", amount: "3", unit: "adet", sortOrder: 2 }, { name: "Domates", amount: "3", unit: "adet", sortOrder: 3 }, { name: "Sarımsak", amount: "4", unit: "diş", sortOrder: 4 }, { name: "Zeytinyağı", amount: "1/2", unit: "su bardağı", sortOrder: 5 }, { name: "Tuz", amount: "", unit: "", sortOrder: 6 }, { name: "Şeker", amount: "", unit: "", sortOrder: 7 }, { name: "Maydanoz", amount: "", unit: "", sortOrder: 8 }],
      steps: [{ stepNumber: 1, instruction: "Patlıcanları alacalı soyun, yarın ve tuzlu suda bekletin.", timerSeconds: 900 }, { stepNumber: 2, instruction: "Soğanları halka kesin, zeytinyağında kavurun." }, { stepNumber: 3, instruction: "Domatesleri rendeleyin, sarımsakla ekleyin." }, { stepNumber: 4, instruction: "Patlıcanları tepsiye dizin, harcı doldurun." }, { stepNumber: 5, instruction: "Üzerine sıcak su ekleyin, 180°C fırında 40 dk pişirin.", timerSeconds: 2400 }],
    },
    {
      ...
      ingredients: [{ name: "Haşlanmış nohut", amount: "400", unit: "gr", sortOrder: 1 }, { name: "Tahin", amount: "3", unit: "yemek kaşığı", sortOrder: 2 }, { name: "Limon suyu", amount: "2", unit: "yemek kaşığı", sortOrder: 3 }, { name: "Sarımsak", amount: "1", unit: "diş", sortOrder: 4 }, { name: "Zeytinyağı", amount: "", unit: "", sortOrder: 5 }, { name: "Tuz", amount: "", unit: "", sortOrder: 6 }, { name: "Kimyon", amount: "", unit: "", sortOrder: 7 }, { name: "Pul biber", amount: "0.5", unit: "çay kaşığı", sortOrder: 8 }],
      steps: [{ stepNumber: 1, instruction: "Tüm malzemeleri blender'a koyun." }, { stepNumber: 2, instruction: "Pürüzsüz olana kadar çekin. Gerekirse su ekleyin." }, { stepNumber: 3, instruction: "Tabağa alın, zeytinyağı ve pul biber ile süsleyin." }],
    },
    {
      ...
      ingredients: [{ name: "Baklava yufkası", amount: "500", unit: "gr", sortOrder: 1, group: "Baklava için" }, { name: "Ceviz içi", amount: "300", unit: "gr", sortOrder: 2, group: "Baklava için" }, { name: "Tereyağı", amount: "250", unit: "gr", sortOrder: 3, group: "Baklava için" }, { name: "Şeker", amount: "3", unit: "su bardağı", sortOrder: 4, group: "Şerbet için" }, { name: "Su", amount: "2", unit: "su bardağı", sortOrder: 5, group: "Şerbet için" }, { name: "Limon suyu", amount: "1", unit: "tatlı kaşığı", sortOrder: 6, group: "Şerbet için" }],
      steps: [{ stepNumber: 1, instruction: "Cevizleri çekin. Tereyağını eritin." }, { stepNumber: 2, instruction: "Yufkaları tepsiye sererek aralarına tereyağı sürün." }, { stepNumber: 3, instruction: "Her 3-4 yufkada bir ceviz serpin." }, { stepNumber: 4, instruction: "Baklava şeklinde kesin. 170°C fırında 45 dk pişirin.", timerSeconds: 2700 }, { stepNumber: 5, instruction: "Şerbeti hazırlayın: şeker ve suyu kaynatın, limon ekleyin." }, { stepNumber: 6, instruction: "Sıcak baklavaya soğuk şerbeti gezdirin." }],
    },
    // ─── İçecekler ─────────────────────────────────────
    {
      ...
      ingredients: [{ name: "Türk kahvesi", amount: "2", unit: "tatlı kaşığı", sortOrder: 1 }, { name: "Su", amount: "2", unit: "fincan", sortOrder: 2 }, { name: "Şeker", amount: "", unit: "isteğe bağlı", sortOrder: 3 }],
      steps: [{ stepNumber: 1, instruction: "Cezveye su ve şekeri (varsa) koyun." }, { stepNumber: 2, instruction: "Kahveyi ekleyin, karıştırmadan kısık ateşe koyun." }, { stepNumber: 3, instruction: "Köpük yükselince fincanlara paylaştırın. Tekrar köpürtüp dökün." }],
    },
    {
      ...
      tags: ["pratik", "30-dakika-alti", "vejetaryen"],
      ingredients: [{ name: "Yoğurt", amount: "2", unit: "su bardağı", sortOrder: 1 }, { name: "Su", amount: "1", unit: "su bardağı", sortOrder: 2 }, { name: "Tuz", amount: "1/2", unit: "tatlı kaşığı", sortOrder: 3 }],
      steps: [{ stepNumber: 1, instruction: "Yoğurt, su ve tuzu derin bir kaba alın." }, { stepNumber: 2, instruction: "Blender veya çırpıcı ile köpürene kadar çırpın." }, { stepNumber: 3, instruction: "Soğuk servis edin." }],
    },
    {
      ...
      ingredients: [{ name: "Beyaz rom", amount: "50", unit: "ml", sortOrder: 1 }, { name: "Lime", amount: "1", unit: "adet", sortOrder: 2 }, { name: "Nane yaprakları", amount: "8-10", unit: "adet", sortOrder: 3 }, { name: "Şeker", amount: "2", unit: "tatlı kaşığı", sortOrder: 4 }, { name: "Soda", amount: "", unit: "tamamlayacak kadar", sortOrder: 5 }, { name: "Buz", amount: "", unit: "bol", sortOrder: 6 }],
      steps: [{ stepNumber: 1, instruction: "Bardağa nane yapraklarını, lime dilimlerini ve şekeri koyun. Muddler ile ezin." }, { stepNumber: 2, instruction: "Buz ekleyin, romu dökün." }, { stepNumber: 3, instruction: "Soda ile tamamlayın, nazikçe karıştırın." }],
    },
    {
      ...
      ingredients: [{ name: "Limon", amount: "4", unit: "adet", sortOrder: 1 }, { name: "Şeker", amount: "4", unit: "yemek kaşığı", sortOrder: 2 }, { name: "Su", amount: "1", unit: "litre", sortOrder: 3 }, { name: "Nane", amount: "", unit: "süslemek için", sortOrder: 4, isOptional: true }],
      steps: [{ stepNumber: 1, instruction: "Limonların kabuğunu rendeleyin, suyunu sıkın." }, { stepNumber: 2, instruction: "Blender'a limon suyu, kabuk rendesi, şeker ve suyu koyun." }, { stepNumber: 3, instruction: "Kısa süre çekin (kabuğu parçalamayın), süzün. Soğuk servis edin." }],
    },
    {
      ...
      ingredients: [{ name: "Hazır şalgam suyu", amount: "500", unit: "ml", sortOrder: 1 }, { name: "Limon", amount: "1", unit: "dilim", sortOrder: 2, isOptional: true }],
      steps: [{ stepNumber: 1, instruction: "Şalgam suyunu bardaklara paylaştırın." }, { stepNumber: 2, instruction: "Buz ve limon dilimi ile servis edin." }],
    },
  ];
